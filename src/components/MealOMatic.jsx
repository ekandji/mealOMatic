    ...
    <div className="min-h-screen bg-white flex flex-col justify-center items-center p-4">
      <div className="max-w-2xl w-full text-center">
        <div className="flex justify-center items-center mb-8">
          <ChefHat size={48} className="text-emerald-600 mr-4"/>
        ...
        <div className="space-y-4">
          ...
          <Button 
            ...
            className="w-full bg-emerald-600 hover:bg-emerald-700 text-white p-4 text-lg"
          >
            Parse My Recipe
          </Button>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            {[
              ...
              >
                <Wheat className="text-emerald-500 opacity-50" size={20} />
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-100 p-4 rounded text-center">
              <Flame className="mx-auto mb-2 text-emerald-600" />
            ...
            <div className="bg-gray-100 p-4 rounded text-center">
              <Wheat className="mx-auto mb-2 text-emerald-600" />
